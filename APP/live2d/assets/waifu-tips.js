...
function initModel(waifuPath, type) {
    ...
    $('.waifu-tool .fui-info-circle').click(function (){
       ...
       showMessage("我是使用了live2D技术实现的看板娘，某个程序员视我为珍宝，把我当女儿，如果未来有一天我能变成他真正的女儿，他会开心吗？",10000,true);
    });
...
function loadTipsMessage(result) {
    ...
    $('.waifu-tool .fui-photo').click(function(){
    	showMessage("爸爸他好像怎么截图都截不到我,然后就放弃了呢", 5000, true);
...
//			ws.draw(bitmap,function(){	//不成功
//				console.log('截屏绘制图片成功');
//				var filename = Date.now()+"live2d.png"
//		    	bitmap.save("/storage/emulated/0/DCIM/Camera/"+filename,{
//		    		overwrite:true,
//		    		format:"png",
//		    		quality:50,
//		    	},function(){
//		    		console.log("save success");
//		    		showMessage("我的自拍已经保存在手机相册里了哦~");
//		    		bitmap.clear();
//		    	},function(){
...
//		    });
    ...
    $('.waifu-tool .fui-eye').on('click',function (){
